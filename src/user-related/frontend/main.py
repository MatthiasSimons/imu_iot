...
class Plot:
    def __init__(self, root):
        ...
        self.ax3.set_title("process state")
    ...
    def plotter(self):
        ...
        self.ax2.plot(acceleration_fft, marker='o', color='orange')
        self.ax3.plot(prediction_history_trommel, marker='', color='orange')
        self.ax3.plot(prediction_history_pumpe, marker='', color='blue')
        self.ax3.plot(prediction_history_betriebszustand, marker='', color='red')
