# imu.csv MicroPython driver for the InvenSense inertial measurement units
...
# At runtime try to continue returning last good acceleration value. We don't want aircraft
